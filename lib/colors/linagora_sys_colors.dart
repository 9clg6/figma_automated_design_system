...
class LinagoraSysColors {
  ...
  LinagoraSysColors._material()
      : primary = const Color(0xFF0A84FF),
        ...
        inversePrimary = const Color(0xFFBFDFFF),
        ...
        tertiaryContainer = const Color(0xFFFCFCFC),
        onTertiaryContainer = const Color(0xFF37383A),
        error = const Color(0xFFFF3347),
        onError = const Color(0xFFFFFFFF),
        errorContainer = const Color(0xFFFFD2D7),
        onErrorContainer = const Color(0xFF7A1E27),
        ...
        surfaceTint = const Color(0xFF0A84FF),
        ...
        _surfaceTintDark = const Color(0xFF0A84FF),

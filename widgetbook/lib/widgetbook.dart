...
import 'package:widgetbook_workspace/components/fab_component/fab_use_case.dart';
...
import 'package:widgetbook_workspace/components/menu_new_component/menu_new_use_case.dart';
          ...
          children: [
            ...
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => badgesVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
            ...
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => bubbleMediaVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => bubbleMessageVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => bubbleThreadVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => buttonsVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => cardsVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => chatMessageVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => checkboxesVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => chipsVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => datePickersVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
            ...
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => fabVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
            ...
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => iconButtonVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => inputFieldVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => labelVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
            ...
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => membersListVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Default',
                  builder: (context) => menuNewDefaultUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
            ...
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => messageTypeIconVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => navigationRailVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => pinEventsVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
            ...
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => settingsVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => sideSheetsVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => slidersVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => snackbarsVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => switchVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
            ...
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => timestampVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => tooltipsVariantsUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              ...
              useCases: [
                WidgetbookUseCase(
                  name: 'Variants',
                  builder: (context) => typingBarVariantsUseCase(context),
                ),
              ],
            ),
          ],
